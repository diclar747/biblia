...
const backgrounds = [
  // --- MONTAÑAS (10) ---
  { id: 'm1', name: 'Cumbre Nevada', category: 'montanas', imageUrl: 'https://picsum.photos/seed/mountain01/600/600' },
  { id: 'm2', name: 'Alpes Suizos', category: 'montanas', imageUrl: 'https://picsum.photos/seed/mountain02/600/600' },
  { id: 'm3', name: 'Monte Everest', category: 'montanas', imageUrl: 'https://picsum.photos/seed/mountain03/600/600' },
  { id: 'm4', name: 'Refugio de Cumbre', category: 'montanas', imageUrl: 'https://picsum.photos/seed/mountain04/600/600' },
  { id: 'm5', name: 'Cordillera Púrpura', category: 'montanas', imageUrl: 'https://picsum.photos/seed/mountain05/600/600' },
  { id: 'm6', name: 'Atardecer de Roca', category: 'montanas', imageUrl: 'https://picsum.photos/seed/mountain06/600/600' },
  { id: 'm7', name: 'Paso de Montaña', category: 'montanas', imageUrl: 'https://picsum.photos/seed/mountain07/600/600' },
  { id: 'm8', name: 'Picos Azules', category: 'montanas', imageUrl: 'https://picsum.photos/seed/mountain08/600/600' },
  { id: 'm9', name: 'Valle Alto', category: 'montanas', imageUrl: 'https://picsum.photos/seed/mountain09/600/600' },
  { id: 'm10', name: 'Dolomitas', category: 'montanas', imageUrl: 'https://picsum.photos/seed/mountain10/600/600' },

  // --- CASCADAS (10) ---
  { id: 'c1', name: 'Cascada Salvaje', category: 'cascadas', imageUrl: 'https://picsum.photos/seed/waterfall01/600/600' },
  { id: 'c2', name: 'Salto del Ángel', category: 'cascadas', imageUrl: 'https://picsum.photos/seed/waterfall02/600/600' },
  { id: 'c3', name: 'Cascada de Bosque', category: 'cascadas', imageUrl: 'https://picsum.photos/seed/waterfall03/600/600' },
  { id: 'c4', name: 'Río de Roca', category: 'cascadas', imageUrl: 'https://picsum.photos/seed/waterfall04/600/600' },
  { id: 'c5', name: 'Cascada de Selva', category: 'cascadas', imageUrl: 'https://picsum.photos/seed/waterfall05/600/600' },
  { id: 'c6', name: 'Salto Escondido', category: 'cascadas', imageUrl: 'https://picsum.photos/seed/waterfall06/600/600' },
  { id: 'c7', name: 'Cascada Islandia', category: 'cascadas', imageUrl: 'https://picsum.photos/seed/waterfall07/600/600' },
  { id: 'c8', name: 'Flujo Rocoso', category: 'cascadas', imageUrl: 'https://picsum.photos/seed/waterfall08/600/600' },
  { id: 'c9', name: 'Cañón y Agua', category: 'cascadas', imageUrl: 'https://picsum.photos/seed/waterfall09/600/600' },
  { id: 'c10', name: 'Cascada Nebulosa', category: 'cascadas', imageUrl: 'https://picsum.photos/seed/waterfall10/600/600' },

  // --- BOSQUES (10) ---
  { id: 'b1', name: 'Niebla del Bosque', category: 'bosques', imageUrl: 'https://picsum.photos/seed/forest01/600/600' },
  { id: 'b2', name: 'Bosque Místico', category: 'bosques', imageUrl: 'https://picsum.photos/seed/forest02/600/600' },
  { id: 'b3', name: 'Senderos Dorados', category: 'bosques', imageUrl: 'https://picsum.photos/seed/forest03/600/600' },
  { id: 'b4', name: 'Rayos de Sol', category: 'bosques', imageUrl: 'https://picsum.photos/seed/forest04/600/600' },
  { id: 'b5', name: 'Pinos Gigantes', category: 'bosques', imageUrl: 'https://picsum.photos/seed/forest05/600/600' },
  { id: 'b6', name: 'Bosque de Bambú', category: 'bosques', imageUrl: 'https://picsum.photos/seed/forest06/600/600' },
  { id: 'b7', name: 'Otoño Pintoresco', category: 'bosques', imageUrl: 'https://picsum.photos/seed/forest07/600/600' },
  { id: 'b8', name: 'Arces Rojos', category: 'bosques', imageUrl: 'https://picsum.photos/seed/forest08/600/600' },
  { id: 'b9', name: 'Niebla Verde', category: 'bosques', imageUrl: 'https://picsum.photos/seed/forest09/600/600' },
  { id: 'b10', name: 'Hojas de Luz', category: 'bosques', imageUrl: 'https://picsum.photos/seed/forest10/600/600' },

  // --- LAGOS Y MARES (10) ---
  { id: 'l1', name: 'Lago Sereno', category: 'lagos_mares', imageUrl: 'https://picsum.photos/seed/sea01/600/600' },
  { id: 'l2', name: 'Playa Tropical', category: 'lagos_mares', imageUrl: 'https://picsum.photos/seed/sea02/600/600' },
  { id: 'l3', name: 'Lago Espejo', category: 'lagos_mares', imageUrl: 'https://picsum.photos/seed/sea03/600/600' },
  { id: 'l4', name: 'Océano Abierto', category: 'lagos_mares', imageUrl: 'https://picsum.photos/seed/sea04/600/600' },
  { id: 'l5', name: 'Atardecer Marino', category: 'lagos_mares', imageUrl: 'https://picsum.photos/seed/sea05/600/600' },
  { id: 'l6', name: 'Acantilado del Mar', category: 'lagos_mares', imageUrl: 'https://picsum.photos/seed/sea06/600/600' },
  { id: 'l7', name: 'Lago en las Nubes', category: 'lagos_mares', imageUrl: 'https://picsum.photos/seed/sea07/600/600' },
  { id: 'l8', name: 'Muelle al Amanecer', category: 'lagos_mares', imageUrl: 'https://picsum.photos/seed/sea08/600/600' },
  { id: 'l9', name: 'Islas de Coral', category: 'lagos_mares', imageUrl: 'https://picsum.photos/seed/sea09/600/600' },
  { id: 'l10', name: 'Marea Baja', category: 'lagos_mares', imageUrl: 'https://picsum.photos/seed/sea10/600/600' },

  // --- AMANECERES Y ATARDECERES (10) ---
  { id: 'a1', name: 'Cielo Naranja', category: 'amaneceres_atardeceres', imageUrl: 'https://picsum.photos/seed/sunrise01/600/600' },
  { id: 'a2', name: 'Amanecer de Oro', category: 'amaneceres_atardeceres', imageUrl: 'https://picsum.photos/seed/sunrise02/600/600' },
  { id: 'a3', name: 'Atardecer de Nubes', category: 'amaneceres_atardeceres', imageUrl: 'https://picsum.photos/seed/sunrise03/600/600' },
  { id: 'a4', name: 'Sol Poniente', category: 'amaneceres_atardeceres', imageUrl: 'https://picsum.photos/seed/sunrise04/600/600' },
  { id: 'a5', name: 'Amanecer en la Colina', category: 'amaneceres_atardeceres', imageUrl: 'https://picsum.photos/seed/sunrise05/600/600' },
  { id: 'a6', name: 'Silueta de Pinos', category: 'amaneceres_atardeceres', imageUrl: 'https://picsum.photos/seed/sunrise06/600/600' },
  { id: 'a7', name: 'Atardecer Rosa', category: 'amaneceres_atardeceres', imageUrl: 'https://picsum.photos/seed/sunrise07/600/600' },
  { id: 'a8', name: 'Cielo Encendido', category: 'amaneceres_atardeceres', imageUrl: 'https://picsum.photos/seed/sunrise08/600/600' },
  { id: 'a9', name: 'Horizonte de Fuego', category: 'amaneceres_atardeceres', imageUrl: 'https://picsum.photos/seed/sunrise09/600/600' },
  { id: 'a10', name: 'Último Rayo', category: 'amaneceres_atardeceres', imageUrl: 'https://picsum.photos/seed/sunrise10/600/600' },

  // --- VALLES Y RÍOS (10) ---
  { id: 'v1', name: 'Río Fluyente', category: 'valles_rios', imageUrl: 'https://picsum.photos/seed/valley01/600/600' },
  { id: 'v2', name: 'Valle Verde', category: 'valles_rios', imageUrl: 'https://picsum.photos/seed/valley02/600/600' },
  { id: 'v3', name: 'Río en Otoño', category: 'valles_rios', imageUrl: 'https://picsum.photos/seed/valley03/600/600' },
  { id: 'v4', name: 'Meandro de Cañón', category: 'valles_rios', imageUrl: 'https://picsum.photos/seed/valley04/600/600' },
  { id: 'v5', name: 'Valle Suizo', category: 'valles_rios', imageUrl: 'https://picsum.photos/seed/valley05/600/600' },
  { id: 'v6', name: 'Pradera y Corriente', category: 'valles_rios', imageUrl: 'https://picsum.photos/seed/valley06/600/600' },
  { id: 'v7', name: 'Río Silencioso', category: 'valles_rios', imageUrl: 'https://picsum.photos/seed/valley07/600/600' },
  { id: 'v8', name: 'Campo de Trigo', category: 'valles_rios', imageUrl: 'https://picsum.photos/seed/valley08/600/600' },
  { id: 'v9', name: 'Río de Piedras', category: 'valles_rios', imageUrl: 'https://picsum.photos/seed/valley09/600/600' },
  { id: 'v10', name: 'Flores y Valle', category: 'valles_rios', imageUrl: 'https://picsum.photos/seed/valley10/600/600' },
